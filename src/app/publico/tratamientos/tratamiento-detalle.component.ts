        ...
        <div class="contenedor detalle__grid">
          ...
          <div>
            ...
            <div class="detalle__datos">
              ...
              <div class="dato">
                <span class="dato__label">Tiempo aproximado</span>
            ...
            <div class="detalle__acciones">
              @if (redes.whatsapp()) {
                <a [href]="whatsappTratamiento(t)" target="_blank" rel="noopener" class="btn btn--primario">Consultar por WhatsApp</a>
              }
              <a routerLink="/tratamientos" class="btn btn--linea">Ver más tratamientos</a>
            </div>
...
export class TratamientoDetalleComponent {
  ...
  whatsappTratamiento(t: { nombre: string; precio: number }): string {
    const texto = `Hola, quiero consultar por el tratamiento ${t.nombre} (${soles(t.precio)}).`;
