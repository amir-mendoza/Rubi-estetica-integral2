      ...
      <div class="contenedor historia">
        <div>
          ...
          <p>
            ...
            facial. Cada persona recibe orientación sobre sesiones, tiempos y cuidados en casa.
          </p>
...
export class NosotrosComponent {
  valores = [
    ...
    { titulo: 'Seguimiento cercano', texto: 'El equipo orienta cada tratamiento con observaciones, recomendaciones y cuidados posteriores.' },
