          ...
          <article class="sede">
            ...
            <div class="sede__info">
              ...
              <div class="sede__acciones">
                @if (redes.whatsapp()) {
                  <a [href]="whatsappLocal(l)" target="_blank" rel="noopener" class="btn btn--primario btn--sm">Consultar esta sede</a>
                }
...
export class LocalesComponent {
  ...
  whatsappLocal(local: { nombre: string; direccion: string }): string {
    const texto = `Hola, quiero consultar por la atencion en ${local.nombre}, ${local.direccion}.`;
